# TeacherLM Class Diagram - Split, Titles Only

## Page 1 of 4 - Conversation, Files, Documents, Sections, Chunks

```mermaid
%%{init: {
  "theme": "base",
  "themeCSS": ".classTitle, .classGroup text { font-size: 24px !important; font-weight: 800 !important; } .classGroup rect { stroke-width: 3px !important; } .edgeLabel, .label, .relation { font-size: 17px !important; font-weight: 700 !important; }",
  "themeVariables": {
    "background": "#ffffff",
    "primaryColor": "#f8fafc",
...
## Page 2 of 4 - Course Structure, Lessons, Chapter Quizzes
...
## Page 3 of 4 - Concepts, Knowledge Graph, Knowledge Checks
...
## Page 4 of 4 - Course Builder and Runtime Settings
